...
import { DollarSign, BarChart3, TrendingUp, TrendingDown, Wifi, RefreshCw } from 'lucide-react';
      ...
      <div className="flex justify-between items-center flex-wrap gap-4">
        ...
        <div className="flex items-center gap-4">
          ...
          <ToggleSwitch
            ...
            description={isRealTimeEnabled ? "Auto-updating prices" : "Manual refresh only"}
            size="md"
            color="primary"
          />
        ...
        <div className="flex items-center justify-between">
          <div>
            ...
            <div className="flex items-center gap-2">
              <p className="text-3xl font-bold gradient-text-secondary">{formatCurrency(realTimeMetrics.totalValue)}</p>
              {isLoading && <Wifi size={16} className="text-blue-400 animate-pulse" />}
              {isDataStale && <RefreshCw size={16} className="text-yellow-400" />}
            </div>
          </div>
