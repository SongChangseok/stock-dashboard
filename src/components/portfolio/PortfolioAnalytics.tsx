...
const AnalyticsCard: React.FC<AnalyticsCardProps> = ({
  ...
  return (
    <div className={`glass-card-dark rounded-2xl p-6 hover:scale-105 transition-all duration-300 ${className}`}>
  ...
  if (state.stocks.length === 0) {
    return (
      <div className="glass-card-dark rounded-2xl p-8 text-center">
        ...
        <p className="text-slate-400">Add some stocks to your portfolio to see analytics.</p>
      </div>
    );
  }
